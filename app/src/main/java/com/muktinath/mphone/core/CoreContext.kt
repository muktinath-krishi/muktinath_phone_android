 ...
 */
package com.muktinath.mphone.core
...
import com.muktinath.mphone.BuildConfig
...
import com.muktinath.mphone.contacts.ContactsManager
import org.linphone.core.tools.Log
import com.muktinath.mphone.notifications.NotificationsManager
import com.muktinath.mphone.telecom.TelecomManager
import com.muktinath.mphone.ui.call.CallActivity
import com.muktinath.mphone.utils.ActivityMonitor
...
class CoreContext
    ...
    private val coreListener = object : CoreListenerStub() {
        ...
        override fun onConfiguringStatus(
            ...
            if (status == ConfiguringState.Successful) {
                ...
                showGreenToastEvent.postValue(
                    Event(
                        Pair(
                            com.muktinath.mphone.R.string.remote_provisioning_config_applied_toast,
                            com.muktinath.mphone.R.drawable.smiley
                        )
                    )
                )
                ...
                showRedToastEvent.postValue(
                    Event(
                        Pair(
                            com.muktinath.mphone.R.string.remote_provisioning_config_failed_toast,
                            com.muktinath.mphone.R.drawable.warning_circle
                        )
                    )
                )
            }
            ...
            when (currentState) {
                ...
                Call.State.Error -> {
                    ...
                    showFormattedRedToastEvent.postValue(
                        Event(Pair(text, com.muktinath.mphone.R.drawable.warning_circle))
                    )
                }
                else -> {
                }
        ...
        override fun onTransferStateChanged(core: Core, transfered: Call, state: Call.State) {
            ...
            if (state == Call.State.Connected) {
                val icon = com.muktinath.mphone.R.drawable.phone_transfer
                showGreenToastEvent.postValue(
                    Event(Pair(com.muktinath.mphone.R.string.call_transfer_successful_toast, icon))
                )
            }
        }
    ...
    override fun run() {
        ...
        val gitVersion = AppUtils.getString(com.muktinath.mphone.R.string.mphone_app_version)
        val gitBranch = AppUtils.getString(com.muktinath.mphone.R.string.mphone_app_branch)
    ...
    fun computeUserAgent() {
        ...
        val appName = context.getString(com.muktinath.mphone.R.string.app_name)
