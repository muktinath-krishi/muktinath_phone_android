 ...
 */
package com.muktinath.mphone.ui.main.help.viewmodel
...
import com.muktinath.mphone.contacts.ContactLoader.Companion.NATIVE_ADDRESS_BOOK_FRIEND_LIST
...
class HelpViewModel
    ...
    init {
        ...
        val appGitDescribe = AppUtils.getString(R.string.mphone_app_version)
        val appBranch = AppUtils.getString(R.string.mphone_app_branch)
